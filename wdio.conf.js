...
const stepsFolders = './features/steps';
let steps = [];

require('isomorphic-fetch')

fs.readdirSync(stepsFolders).forEach((file) => {
    if(path.extname(file) === '.js'){
        steps.push(stepsFolders + '/' + file);
    }
})
...
exports.config = {
    ...
    baseUrl: 'https://staging-family.godeltech.com/division',
    //
